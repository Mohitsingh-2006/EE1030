...
\begin{enumerate}
    ...
    \item 15
\end{enumerate}
30.Let $f(x)=\frac{x}{(1+x^n)^\frac{1}{n}}$ for $ n\geq2$ and $g(x)= \underbrace {(f\circ  f\circ ...\circ f)(x)}_{\text{ f occurs n times}}$.Then $\int x^{n-2} g(x)dx$ equals.
\hfill(2007-3 marks)\\
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item $a=b=c$
\end{enumerate}
32.Let$f(x)=x^2$ and $g(x)=\sin x$ for all $x\in R$ .Then the set of all $x$ satisfying $(f\circ g\circ g\circ f)(x)=(g\circ g\circ f)(x)$,where $(f\circ g)(x)=f(g(x))$,is
\hfill(2011)
\begin{enumerate}
