...
\draw[domain=26.25:33.75,samples=100,smooth] plot (\x,{1.5*sin(0.9*\x r -21.25 r ) +12.25});
\end{scope}
\draw [short] (26.25,12.25) -- (26.25,4.75);
\draw [->, >=Stealth] (26.25,12.25) -- (27.5,12.25);
\draw [->, >=Stealth] (26.25,11.5) -- (27.5,11.5);
\draw [->, >=Stealth] (26.25,9.25) -- (25.25,9.25);
\draw [->, >=Stealth] (26.25,8.5) -- (24.75,8.5);
\draw [->, >=Stealth] (26.25,7.75) -- (25.25,7.75);
\draw [->, >=Stealth] (26.25,5.75) -- (27.25,5.75);
...
\draw[domain=25:32.5,samples=100,smooth] plot (\x,{1.5*sin(0.89*\x r -23.1 r ) +12.25});
\end{scope}
\draw [short] (25,12.25) -- (25,4.75);
\draw [->, >=Stealth] (25,12.25) -- (23.5,12.25);
\draw [->, >=Stealth] (25,11.5) -- (23.75,11.5);
\draw [->, >=Stealth] (25,9.5) -- (25.75,9.5);
\draw [->, >=Stealth] (25,8.75) -- (26.25,8.75);
\draw [->, >=Stealth] (25,8) -- (26.25,8);
\draw [->, >=Stealth] (25,7.25) -- (25.75,7.25);
\draw [->, >=Stealth] (25,5.75) -- (24,5.75);
